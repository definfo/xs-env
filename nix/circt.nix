...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-hLPGfoXJwuaCYcrSvRCm5ob+aJdP/XsfAVyf1aB27wc=";
  ...
  preConfigure = ''
    ...
    substituteInPlace cmake/modules/GenVersionFile.cmake --replace "unknown git version" "${finalAttrs.src.rev}"
  '';
